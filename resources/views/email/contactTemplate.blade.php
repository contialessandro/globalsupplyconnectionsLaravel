...
<table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
            <div role="banner">
                ...
                <div class="header" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);" id="emb-email-header-container">
                    ...
                    <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 0px;Margin-bottom: 0px;color: #c3ced9;font-family: Roboto,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
                        <div class="logo-center" align="center" id="emb-email-header"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 246px;" src="http://heroku.dev/img/logo/LightBlueSideBySideNBorderNoText.png" alt="" width="246" /></div>
                    </div>
                    <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                </div>
            </div>
            <div role="section">
                    ...
                    <div class="layout one-col" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                <tr class="layout-full-width" style="background-color: #399595;">
                ...
                <div class="layout one-col fixed-width" style="background-color: #399595; Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                        ...
                        <div class="column" style="text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <p style="Margin-top: 0;Margin-bottom: 0;">
                                    Contact form details below, please attach them to hubspot</p>
                                <p style="Margin-top: 20px;Margin-bottom: 0;">
                                    <strong>Name:</strong>{{$name}}</p><p style="Margin-top: 20px;Margin-bottom: 0;">
                                    <strong>Company:</strong>{{$company}}</p><p style="Margin-top: 20px;Margin-bottom: 0;">
                                    <strong>Email:</strong>{{$email}}</p><p style="Margin-top: 20px;Margin-bottom: 0;">
                                    <strong>Subject:</strong>{{$subjects}}</p><p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;</p>
                                        <strong>Message:</strong>{{$subject}}</p><p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;</p>
