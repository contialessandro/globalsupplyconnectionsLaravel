...
@if($errors->has('subject'))
    <div class="form-group col-md-6 has-error has-feedback">
        ...
        <input type="email" placeHolder="Subject" name="subject" id="exampleInputEmail2" class="form-control input-lg">
        <span class="glyphicon glyphicon-remove form-control-feedback"></span>
...
@if($errors->has('message'))
    <div class="form-group col-md-12 has-error has-feedback">
        ...
        <textarea placeHolder="Message" rows="3"  name="message" class="form-control input-lg"></textarea>
        <span class="glyphicon glyphicon-remove form-control-feedback"></span>
        <div class="control-label">{{$errors->first('message')}}</div>
